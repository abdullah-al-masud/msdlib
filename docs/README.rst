...
Pytorch should be installed by following installation procedure suggested `here <https://pytorch.org/>`__.
...
Examples
---------
You can find easy examples on how to use the functions and classes from this library `here <https://github.com/abdullah-al-masud/msdlib/tree/master/examples>`__.
...
Examples are available for regression, binary and multi-class classification models `here <https://github.com/abdullah-al-masud/msdlib/tree/master/examples>`__.
...
Examples are available `here <https://github.com/abdullah-al-masud/msdlib/tree/master/examples>`__.
...
.. image:: ../examples/multiclass-classification_torchModel/Classification_result_for_Test_from_pytorch.png
...
Example is available `here <https://github.com/abdullah-al-masud/msdlib/tree/master/examples/class_result_example.py>`__.

-------------
rsquare_rmse: 
-------------

.. image:: ../examples/regression_torchModel/True-Label_VS_Prediction_Scatter_plot_for_Test_from_pytorch.png
...
Example is available `here <https://github.com/abdullah-al-masud/msdlib/tree/master/examples/data_grid_plot_example.py>`__.
...
Example is available `here <https://github.com/abdullah-al-masud/msdlib/tree/master/examples/plot_time_series_example.py>`__.
...
Example is available `here <https://github.com/abdullah-al-masud/msdlib/tree/master/examples/filters_and_spectrogram_example.py>`__.
...
Example can be found `here <https://github.com/abdullah-al-masud/msdlib/tree/master/examples/ProgressBar_example.py>`__.
